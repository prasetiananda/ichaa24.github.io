;(function (window) {
  ...
  const RADIUS = Math.PI * 1
  const CANVASWIDTH = 1500
  const CANVASHEIGHT = 150
  const CANVASID = 'canvas'

  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'CHA', 'COBA LIHAT CHA', 'ADA YANG ANEH NI', 'SEPERTINYA ADA YANG ANEH', 'COBA PENCET LAGI', 'AKU GA BOHONG KOK', 'ADA YANG PENGEN AKU BILANG', 'SEBENARNYA AKU GENGSI NI','MAU NGOMONGNYA','AKU MAU BILANG','KLO SEKRANG AKU', 'KANGENNN KALI',' SAMA ICHA','DAH ITU AJA',' YANG PENGEN AKU BILANG', 'HEHEHEHE..']
